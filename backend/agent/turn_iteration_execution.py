...
class TurnIterationExecutor:
    ...
    def __init__(
        ...
        *,
        ...
        self.stop_hook_feedback_limit = stop_hook_feedback_limit
    ...
    async def execute(
        ...
        *,
    ...
    ) -> AsyncIterator[AgentEvent | IterationExecutionResult]:
        ...
        async for update in stream_provider_response(
            ...
            prefer_stateful_history=execution_state.prefer_stateful_history,
        ...
        execution_state.prefer_stateful_history = (
            provider_stream_result.prefer_stateful_history
        )
        ...
        if not pending_tool_calls:
            ...
            async for update in orchestrate_final_answer(
                ...
                degraded_reason=execution_state.degraded_reason,
                stop_hook_feedback_limit=self.stop_hook_feedback_limit,
            ):
