    ...
    *,
    ...
    if wire_api == "anthropic":
        ...
        return AnthropicAdapter(
            ...
            context_window_verified=settings.context_window_verified,
            max_context_window=settings.max_context_window,
            max_context_window_source=settings.max_context_window_source,
            max_context_window_verified=settings.max_context_window_verified,
    ...
    if normalized == "anthropic":
        ...
        return build_wire_adapter(
            LLMSettings(
                ...
                context_window_source=anthropic_settings["context_window_source"],
                context_window_verified=anthropic_settings["context_window_verified"],
                max_context_window=anthropic_settings["max_context_window"],
                max_context_window_source=anthropic_settings["max_context_window_source"],
                max_context_window_verified=anthropic_settings["max_context_window_verified"],
