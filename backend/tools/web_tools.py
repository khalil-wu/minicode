...
# WebFetch resource controls. Network lifetime is owned by the enclosing
# turn/cancellation signal; do not add a second local timeout.
...
# Bound the response on the wire as well as the processed text. Without this
# guard, ``resp.content`` can allocate an unbounded body before the 100K
# character presentation cap is applied.
